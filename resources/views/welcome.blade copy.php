    ...
    <main class="main" id="top">
        ...
        <div class="swiper theme-slider min-vh-100" data-swiper='{"loop":true,"allowTouchMove":false,"autoplay":{"delay":5000},"effect":"fade","speed":800}'>
          <div class="swiper-wrapper">
            <div class="swiper-slide" data-zanim-timeline="{}">
              <div class="bg-holder" style="background-image:url(img/header-6.jpg);"></div>
              <!--/.bg-holder-->
              <div class="container">
            ...
            <div class="swiper-slide" data-zanim-timeline="{}">
              <div class="bg-holder" style="background-image:url(img/header-5.jpg);"></div>
              <!--/.bg-holder-->
              <div class="container">
                <div class="row min-vh-100 py-8 align-items-center" data-inertia='{"weight":1.5}'>
                  <div class="col-sm-8 col-lg-7 px-5 px-sm-3">
            ...
            <div class="swiper-slide" data-zanim-timeline="{}">
              <div class="bg-holder" style="background-image:url(img/header-1.jpg);"></div>
              <!--/.bg-holder-->
              <div class="container">
                <div class="row min-vh-100 py-8 align-items-center" data-inertia='{"weight":1.5}'>
                  <div class="col-sm-8 col-lg-7 px-5 px-sm-3">
          ...
          <div class="row flex-center text-center pb-6">
            <div class="col-12">
              <div class="position-relative mt-4 py-5 py-md-11">
                <div class="bg-holder rounded-3" style="background-image:url(img/video-screenshot-2.jpg);"></div>
                <!--/.bg-holder-->
        ...
        <div class="container">
          ...
          <div class="row g-0 position-relative mb-4 mb-lg-0">
            <div class="col-lg-6 py-3 py-lg-0 mb-0 position-relative" style="min-height:400px;">
              <div class="bg-holder rounded-ts-lg rounded-te-lg rounded-lg-te-0  " style="background-image:url(img/6.jpg);"></div>
              <!--/.bg-holder-->
            </div>
          ...
          <div class="row g-0 position-relative mb-4 mb-lg-0">
            <div class="col-lg-6 py-3 py-lg-0 mb-0 position-relative order-lg-2" style="min-height:400px;">
              <div class="bg-holder rounded-ts-lg rounded-te-lg rounded-lg-te-0  rounded-lg-ts-0" style="background-image:url(img/7.jpg);"></div>
              <!--/.bg-holder-->
            </div>
          ...
          <div class="row g-0 position-relative mb-4 mb-lg-0">
            <div class="col-lg-6 py-3 py-lg-0 mb-0 position-relative" style="min-height:400px;">
              <div class="bg-holder rounded-ts-lg rounded-te-lg rounded-lg-te-0 rounded-lg-ts-0 rounded-bs-0 rounded-lg-bs-lg " style="background-image:url(img/8.jpg);"></div>
              <!--/.bg-holder-->
            </div>
      ...
      <section>
        <div class="container">
          ...
          <div class="row">
            <div class="col-lg-6 pe-lg-3"><img class="rounded-3 img-fluid" src="img/why-choose-us.jpg" alt="about"></div>
          ...
          <div class="row">
            <div class="col-md-6 col-lg-4 mt-4" data-zanim-timeline="{}" data-zanim-trigger="scroll">
              <div class="px-3 py-4 px-lg-4">
                <div class="overflow-hidden"><img src="img/icons/sharing.png" alt="icon" height="37" data-zanim-xs='{"delay":0}'></div>
                <div class="overflow-hidden">
            ...
            <div class="col-md-6 col-lg-4 mt-4" data-zanim-timeline="{}" data-zanim-trigger="scroll">
              <div class="px-3 py-4 px-lg-4">
                <div class="overflow-hidden"><img src="img/icons/mail.png" alt="icon" height="37" data-zanim-xs='{"delay":0}'></div>
                <div class="overflow-hidden">
            ...
            <div class="col-md-6 col-lg-4 mt-4" data-zanim-timeline="{}" data-zanim-trigger="scroll">
              <div class="px-3 py-4 px-lg-4">
                <div class="overflow-hidden"><img src="img/icons/target.png" alt="icon" height="37" data-zanim-xs='{"delay":0}'></div>
                <div class="overflow-hidden">
            ...
            <div class="col-md-6 col-lg-4 mt-4" data-zanim-timeline="{}" data-zanim-trigger="scroll">
              <div class="px-3 py-4 px-lg-4">
                <div class="overflow-hidden"><img src="img/icons/world-globe.png" alt="icon" height="37" data-zanim-xs='{"delay":0}'></div>
                <div class="overflow-hidden">
            ...
            <div class="col-md-6 col-lg-4 mt-4" data-zanim-timeline="{}" data-zanim-trigger="scroll">
              <div class="px-3 py-4 px-lg-4">
                <div class="overflow-hidden"><img src="img/icons/money.png" alt="icon" height="37" data-zanim-xs='{"delay":0}'></div>
                <div class="overflow-hidden">
            ...
            <div class="col-md-6 col-lg-4 mt-4" data-zanim-timeline="{}" data-zanim-trigger="scroll">
              <div class="px-3 py-4 px-lg-4">
                <div class="overflow-hidden"><img src="img/icons/data-analytics.png" alt="icon" height="37" data-zanim-xs='{"delay":0}'></div>
                <div class="overflow-hidden">
      ...
      <!-- <section> begin ============================-->
      <section>
        <div class="bg-holder overlay overlay-elixir" style="background-image:url(img/background-15.jpg);"></div>
        <!--/.bg-holder-->
        <div class="container">
          <div class="d-flex"><span class="me-3"> <img src="img/checkmark.png" alt="checkmark" style="width: 55px"></span>
            <div class="flex-1">
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="row px-lg-8">
                  <div class="col-4 col-md-3 mx-auto"><img class="rounded-3 mx-auto img-fluid" src="img/client1.png" alt="Member"></div>
              ...
              <div class="swiper-slide">
                <div class="row px-lg-8">
                  <div class="col-4 col-md-3 mx-auto"><img class="rounded-3 mx-auto img-fluid" src="img/client2.png" alt="Member"></div>
                  <div class="col-md-9 mt-4 mt-md-0 px-4 px-sm-3">
              ...
              <div class="swiper-slide">
                <div class="row px-lg-8">
                  <div class="col-4 col-md-3 mx-auto"><img class="rounded-3 mx-auto img-fluid" src="img/client3.png" alt="Member"></div>
                  <div class="col-md-9 mt-4 mt-md-0 px-4 px-sm-3">
      ...
      <div class="bg-200 py-6">
        <div class="container">
          <div class="row align-items-center" data-zanim-timeline="{}" data-zanim-trigger="scroll">
            <div class="col-4 col-md-2 my-3 overflow-hidden"><img class="img-fluid" src="img/partner/logo2.png" alt="partnerco" data-zanim-xs="{}"></div>
            <div class="col-4 col-md-2 my-3 overflow-hidden"><img class="img-fluid" src="img/partner/logo1.png" alt="tvc" data-zanim-xs="{}"></div>
            <div class="col-4 col-md-2 my-3 overflow-hidden"><img class="img-fluid" src="img/partner/logo6.png" alt="arcade" data-zanim-xs="{}"></div>
            <div class="col-4 col-md-2 my-3 overflow-hidden"><img class="img-fluid" src="img/partner/logo3.png" alt="bearbrand" data-zanim-xs="{}"></div>
            <div class="col-4 col-md-2 my-3 overflow-hidden"><img class="img-fluid" src="img/partner/logo5.png" alt="fast brothers" data-zanim-xs="{}"></div>
            <div class="col-4 col-md-2 my-3 overflow-hidden"><img class="img-fluid" src="img/partner/logo4.png" alt="harculis beards" data-zanim-xs="{}"></div>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          ...
          <div class="row g-4">
            <div class="col-md-6 col-lg-4">
              <div class="card"><a href="news/news.html"><img class="card-img-top" src="img/9.jpg" alt="Featured Image"></a>
                <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
            ...
            <div class="col-md-6 col-lg-4">
              <div class="card"><a href="news/news.html"><img class="card-img-top" src="img/10.jpg" alt="Featured Image"></a>
                <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                  <div class="overflow-hidden"><a href="news/news.html">
            ...
            <div class="col-md-6 col-lg-4">
              <div class="card"><a href="news/news.html"><img class="card-img-top" src="img/11.jpg" alt="Featured Image"></a>
                <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                  <div class="overflow-hidden"><a href="news/news.html">
